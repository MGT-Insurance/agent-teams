...
- **Deliverable is a published HTML artifact**, not a wall of text. Load the `artifact-design` skill first, publish with an emoji favicon + one-sentence description, then report the URL to the DRI.
